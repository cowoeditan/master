  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?=site_url('user/user')?>"><i class="fa fa-users"></i> <span>Data User</span></a></li>
        <li><a href="<?=site_url('hospital/hospital')?>"><i class="fa fa-hospital-o"></i> <span>Data Hospital</span></a></li>
        <?php } ?>
      </ul>
    </section>
    <!-- /.sidebar -->
